        ...
        <div className="space-y-4 rounded-3xl border border-slate-800 bg-slate-900/80 p-6">
          <div>
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Un atacante puede enviar enlaces maliciosos a los clientes de SuperMax para ejecutar scripts en su navegador y robar cookies de sesión. Esto puede permitir el secuestro de cuentas y el uso fraudulento de puntos de fidelidad.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="text-sm text-slate-400 space-y-2 list-disc list-inside">
              <li>Aplicar codificación contextual de salida antes de renderizar datos del usuario.</li>
              <li>Marcar cookies de sesión con HttpOnly y Secure.</li>
            </ul>
          </div>
        </div>
