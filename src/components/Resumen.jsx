...
export default function Resumen() {
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-3xl border border-slate-800 bg-slate-900/80 p-6">
        <h2 className="text-lg font-semibold text-white">Gobernanza y controles prioritarios</h2>
        <div className="mt-4 grid gap-3 md:grid-cols-3">
          <div className="rounded-2xl border border-slate-800 bg-slate-950/60 p-4">
            <p className="text-xs uppercase tracking-[0.25em] text-slate-500">Prevención</p>
            <p className="mt-2 text-sm text-slate-300">Validación estricta de entrada y salida, consultas parametrizadas y listas blancas.</p>
          </div>
          <div className="rounded-2xl border border-slate-800 bg-slate-950/60 p-4">
            <p className="text-xs uppercase tracking-[0.25em] text-slate-500">Detección</p>
            <p className="mt-2 text-sm text-slate-300">Alertas por patrones de ataque, monitoreo de sesiones y trazabilidad de incidentes.</p>
          </div>
          <div className="rounded-2xl border border-slate-800 bg-slate-950/60 p-4">
            <p className="text-xs uppercase tracking-[0.25em] text-slate-500">Respuesta</p>
            <p className="mt-2 text-sm text-slate-300">Plan de contención, rotación de credenciales y comunicación de incidente basada en evidencia.</p>
          </div>
        </div>
      </div>
    </div>
